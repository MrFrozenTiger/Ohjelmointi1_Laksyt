...
# Oletetaan, että A on yksikköympyrä eli ympyrä, jonka keskipiste on origossa
# ja jonka säde on yksi. Sen ympärille piirretään pienin mahdollinen neliö B siten,
...
# ympyrän pinta-ala on neliön pinta-alasta eli πr^2/4,
...
# laskennan edellä kuvatulla menetelmällä.
